        ...
        {!isAccountCreated ? (
          <>
            ...
            <p className="login-subtext">
              {accountType === 'user' ? (
                <>
                  Join as a <b>student</b> to <u>explore</u> amazing events
                </>
              ) : (
                <>
                  Join as an <b>organization</b> to <u>host</u> amazing events
                </>
              )}
            </p>
          ...
          <>
            ...
            <p className="login-subtext-dark">Make sure to verify your email before logging in!</p>
