  ...
  const fetchRegisteredUsers = async () => {
    ...
    try {
      ...
      const formattedTickets = data.map(ticket => ({
        ...
        checkInTime:
          ticket.status === 'CHECKED_IN' && ticket.updatedAt
                    ...
                    <tbody>
                      {ticketsList.map((ticket, index) => (
                        <tr key={index}>
                          ...
                          <td>
                            <span
                              className={`event-status-badge event-status-${ticket.status.toLowerCase()}`}
                            >
              ...
              <div className="capacity-breakdown-grid">
                ...
                <div className="capacity-stat-card">
                  ...
                  <div className="capacity-stat-description">
                    {analytics.capacityUtilization}% of capacity used
                  </div>
                </div>
