...
describe("Discover component", () => {
  ...
  test("renders event titles", () => {
    render(
      <MemoryRouter>
        <Discover events={sampleEvents} user={null} org={null} isRegistrations={false} isMyEvent={false} />
      </MemoryRouter>
    );
  ...
  test("close button resets selectedEvent", () => {
    render(
      <MemoryRouter>
        <Discover events={sampleEvents} user={{ id: 1 }} org={null} isRegistrations={false} isMyEvent={false} />
      </MemoryRouter>
    );
